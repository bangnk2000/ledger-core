...
- Tests for critical flows MUST be written and FAIL before implementation
- Domain models before application use cases
- Application ports before inbound/outbound adapters
- Application use cases before endpoint wiring
